package CloudletScheduler.Optimizer.ga;
...
public class GAScheduler extends Scheduler {
	private static final int POPULATION_SIZE = MainRunner.Config.POPULATION; // 种群大小
	private static final int MAX_GENERATIONS = MainRunner.Config.MAX_ITER; // 最大迭代次数
