...
public class MainRunner {
    ...
    public static class Config {
        ...
        public static final int POPULATION = 50;  // 增加种群大小以提高多样性
        public static final int MAX_ITER = 1000;   // 增加迭代次数以充分探索
        public static final int ARCHIVE_SIZE = 200; // 增加存档大小以保存更多Pareto解
    }
